    ...
    <?php foreach ($sql as $row) :  ?>
      <div class="content-wrapper">
        ...
        <div class="page-header">
          <img src="../../../../img/<?php echo $row['shoplogo'];?>" alt="img" style="width: 50px; border: 2px solid gray; border-radius: 20px;">
            ...
            <div class="card text-dark">
              ...
              <div class="card-body">
                ...
                <a href="<?php echo $row['link']; ?>" class="d-inline-block text-decoration-none text-dark">
                  ...
                  <a href="mailto:<?php echo $row['email']; ?>" class="d-inline-block text-decoration-none text-dark">
