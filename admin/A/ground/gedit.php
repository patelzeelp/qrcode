                                    ...
                                    <form class="forms-sample" method="post" action="" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="floor-number" name="floor_number">
                                                <option value="G-1" <?php if ($row['floor_number'] === 'G-1') echo 'selected'; ?>>G-1</option>
                                                <option value="G-2" <?php if ($row['floor_number'] === 'G-2') echo 'selected'; ?>>G-2</option>
                                                <option value="G-3" <?php if ($row['floor_number'] === 'G-3') echo 'selected'; ?>>G-3</option>
                                                <option value="G-4" <?php if ($row['floor_number'] === 'G-4') echo 'selected'; ?>>G-4</option>
                                                <option value="G-5" <?php if ($row['floor_number'] === 'G-5') echo 'selected'; ?>>G-5</option>
                                                <option value="G-6" <?php if ($row['floor_number'] === 'G-6') echo 'selected'; ?>>G-6</option>
                                                <option value="G-7" <?php if ($row['floor_number'] === 'G-7') echo 'selected'; ?>>G-7</option>
                                                <option value="G-8" <?php if ($row['floor_number'] === 'G-8') echo 'selected'; ?>>G-8</option>
                                                <option value="G-9" <?php if ($row['floor_number'] === 'G-9') echo 'selected'; ?>>G-9</option>
                                                <option value="G-10" <?php if ($row['floor_number'] === 'G-20') echo 'selected'; ?>>G-10</option>
                                            </select>
                                        </div>
