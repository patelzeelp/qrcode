            ...
            <div class="col-12 grid-margin ">
              <div class="">
                <div class="body">
                  ...
                  <div class="template-demo d-flex btn-fw justify-content-center">
                    <a href="gadd.php">
                      <button type="button" class="btn btn-primary btn-rounded fst-italic  pl-5 pr-5 m-2">Add floor</button>
                    </a>
                  ...
                  <div class="card border border-primary rounded-4">
                    <div class="d-flex justify-content-between">
                      ...
                      <div class="d-inline align-items-center mt-4">
                        <a href="gedit.php?id=<?php echo $row['id']; ?>" class="mr-2">
                        ...
                        <a href="gdelete.php?id=<?php echo $row['id']; ?>">
