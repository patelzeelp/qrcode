                ...
                <div class="content-wrapper">
                    <div class="page-header ">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="../index.php">Floor</a></li>
                                <!-- <li class="breadcrumb-item active" aria-current="page">Buttons</li> -->
                            </ol>
                        </nav>
                    </div>
                    <?php
                    $sql = mysqli_query($con, "SELECT  *  FROM a where floor='ground'and user_id='1'  ORDER BY floor_number ASC");
                                ...
                                <div class="col-12 grid-margin  rounded-4">
                                    <div class="card rounded-4">
                                        <a href="shop/detail.php?id=<?php echo $row['id'] ?>">
                                            <div class="card pl-4 pt-4 pb-2 m-0 rounded-4 ">
